...
# Copied from xmobar's padding-icon.sh:
# https://codeberg.org/xmobar/xmobar/src/branch/master/etc/padding-icon.sh

# Function to create a transparent Wx1 px XPM icon
create_xpm_icon () {
timestamp=$(date)
pixels=$(for _ in $(seq "$1"); do printf "."; done)
...
/* updated by by tray-padding-icon.sh which is run  */
/* by xmobar.                                     */
/* Created: ${timestamp} */
